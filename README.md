...
Специальные файлы предназначены для ввода и вывода данных с аппаратных устройств. Настоящую работу делает **драйвер**, а спец файлы являются порталами связи с драйверами. Различают символьные и блочные спец файлы устройств.
