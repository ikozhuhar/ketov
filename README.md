...
Сокеты в Linux — это конечные точки сетевых коммуникаций. Они являются «порталами», через которые можно отправлять байты во внешний мир. 2

Сокеты обеспечивают двухстороннюю связь между двумя процессами. Они являются основными компонентами межсистемной и межпроцессной связи. 1

Основные типы сокетов:

Поточный. Обеспечивает двухсторонний, последовательный, надёжный и недублированный поток данных без определённых границ. 1
Датаграммный. Поддерживает двухсторонний поток сообщений. Приложение, использующее такие сокеты, может получать сообщения в порядке, отличном от последовательности, в которой эти сообщения посылались. 1
Сокет последовательных пакетов. Обеспечивает двухсторонний, последовательный, надёжный обмен датаграммами фиксированной максимальной длины. 1
Простой сокет. Обеспечивает доступ к основным протоколам связи. 1
Сокеты могут использоваться для организации взаимодействия программ на одном компьютере, по локальной сети или через Интернет. 2
